...
# The name of an attribute that is used to indicate that a method or function
# has been generated by dataclasses.
_GENERATED_TAG = "__generated_by_dataclasses__"
...
def _make_annotate_function(__class__, method_name, annotation_fields, return_type):
    ...
    setattr(__annotate__, _GENERATED_TAG, True)
...
class _AutoMethod:
    ...
    __slots__ = ("name", "generator", "cls", "_generated_method", "_lock")
    ...
    def __init__(self, name, generator, cls):
        ...
        # Internal details for locking/threading
        self._generated_method = None
        self._lock = _thread.lock()

    def __repr__(self):
        return (
            f"<{type(self).__name__} Method Generator "
            f"for {self.name!r} on {self.cls.__qualname__!r}>"
        )

    def __get__(self, obj, objtype=None):
        with self._lock:
            # Check again to see if the method has been generated by something
            # that was holding the lock.
            if self._generated_method is None:
                ...
                self._generated_method = self.generator(self.name, self.cls)
                setattr(self._generated_method, _GENERATED_TAG, True)
                setattr(self.cls, self.name, self._generated_method)
...
def is_dataclass_method(func):
    """
    Identify if an object is a function or method generated by dataclasses
    """
    return getattr(func, _GENERATED_TAG, False) or isinstance(func, _AutoMethod)
