...
class _AutoMethod:
    ...
    __slots__ = ("name", "generator", "cls", "_lock")
    ...
    def __get__(self, obj, objtype=None):
        ...
        with self._lock:
            # Pull from the dict to check if the method has been
            # generated by something that previously held the lock
            method = self.cls.__dict__[self.name]
            if method is self:
