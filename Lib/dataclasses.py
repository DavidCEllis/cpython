...
# A tag to indicate that a method or function has been generated by dataclasses
...
def _hash_set_none(cls, func_builder):
...
class _AutoMethod:
    ...
    # Once the method has been generated, this descriptor replaces itself with
    # the generated method.

    __slots__ = ("name", "generator", "cls", "_generated_method", "_lock")

    # Identify ungenerated methods as dataclass methods
    __is_dataclass_method__ = True
...
def _process_class(cls, init, repr, eq, order, unsafe_hash, frozen,
    ...
    hash_action = _hash_action[bool(unsafe_hash),
                               ...
                               has_explicit_hash]
    if hash_action:
        cls.__hash__ = hash_action(cls, func_builder)
...
def is_dataclass_method(func):
    ...
    """
    return getattr(func, _GENERATED_TAG, False)
